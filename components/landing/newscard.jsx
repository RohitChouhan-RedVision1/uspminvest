        ...
        <div className="p-1">
            <Link href={item?.link} target="_blank">
                <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow hover:shadow-xl hover:scale-105 transition-transform dark:bg-gray-800 dark:border-gray-700 relative"> {/* Add 'relative' class */}
                    <Image className="rounded-t-lg w-full h-52" src={item?.image} alt="" />
                    ...
                    <div className="p-4">
                        ...
                        <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">{item.description.slice(0, 70)}...</p>
                    </div>
                </div>
            </Link>
        </div>
