        ...
        return (
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 rounded  py-3 px-6 bg-white">
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormControl>
                                    <Input placeholder="User Name" {...field} aria-label="User Name" className="border  border-[var(--rv-primary)] text-[var(--rv-primary)] placeholder-[var(--rv-primary)]" />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormControl>
                                    <Input placeholder="Mobile" {...field} aria-label="Mobile Number" className="border text-[var(--rv-primary)] border-[var(--rv-primary)] placeholder-[var(--rv-primary)]" />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormControl>
                                    <Input type="email" placeholder="Email" {...field} aria-label="Email" className="border text-[var(--rv-primary)] border-[var(--rv-primary)] placeholder-[var(--rv-primary)]" />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormControl>
                                    <textarea placeholder="Message" {...field} className="w-full border text-[var(--rv-primary)] border-[var(--rv-primary)] p-1 rounded placeholder-[var(--rv-primary)]" aria-label="Message" />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
            ...
            {captchaError && (
              <p className="text-red-500 text-sm mt-2">{captchaError}</p>
                    ...
                    {/* Submit Button */}
                    <Button className="text-white border bg-[var(--rv-primary)]" type="submit">{!loading ? "Submit" : "Loading..."}</Button>
                </form>
            </Form>
        );
    };
            ...
            {isQuizCompleted ? (
                ...
                <div className="flex flex-col">
                    ...
                    <Button
                        ...
                        className="text-white bg-[var(--rv-primary)] border px-4 py-2 rounded-lg hover:bg-[var(--rv-bg-primary)] hover:text-white w-1/3 "
                    >
                        Next
                    </Button>
                </div>
