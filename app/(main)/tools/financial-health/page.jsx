    ...
    return (
      <Form {...form}>
        ...
        >
              ...
              <FormItem>
                <FormControl>
                  <Input
                    ...
                    className="border border-[var(--rv-primary)]  text-[var(--rv-primary)] placeholder-[var(--rv-primary)]]]"
                  />
                </FormControl>
                <FormMessage />
              </FormItem>
              ...
              <FormItem>
                <FormControl>
                  <textarea
                    placeholder="Message"
                    {...field}
                    className="w-full border border-[var(--rv-primary)]  text-[var(--rv-primary)] placeholder-[var(--rv-primary)]]] p-1 rounded"
                    aria-label="Message"
                  />
                </FormControl>
                <FormMessage />
          ...
          {/* Submit Button */}
          <Button className="text-white bg-[var(--rv-primary)]" type="submit" disabled={loading}>
